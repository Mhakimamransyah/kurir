...
class OrderController extends Controller
{
    ...
    public function __construct()
    {
      ...
      $this->middleware('trans',['only' => ['pelanggan_deal_charge','order_baru','pelanggan_cancel_charge','kurir_deal_order','kurir_selesaikan_destinasi','pelanggan_rating_kurir','periksa_alamat']]);      
    }
  ...
  public function get_ketentuan_tarif(Request $request){
   if($request->filled(["id_order_jenis"])){
    ...
    return ResponseBuilder::result(true,"Sukses",Order_jenis::select('id_order_jenis','tarif','jenis','deskripsi_jenis_order')->get(),200); 
  }
}
